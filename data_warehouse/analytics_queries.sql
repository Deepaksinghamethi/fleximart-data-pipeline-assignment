...
/* ---------------------------------------------------------
   ...
   Business Scenario:
   The CEO wants to see sales performance broken down
   by Year → Quarter → Month for 2024.
...
/* ---------------------------------------------------------
   ...
   Business Scenario:
   Identify top 10 products by revenue along with
...
/* ---------------------------------------------------------
   ...
   based on total spending and show summary metrics.
--------------------------------------------------------- */
